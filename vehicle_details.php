...
<html>
    ...
    <body>
        ...
        $stmt = $conn->prepare('SELECT * FROM TblVehicles WHERE VehicleID = "' . $_POST["chosenVehicleID"] . '"');
        $stmt->execute();
        ...
        <form method="post" action="edit_vehicle_date.php">
            ...
            <input type="hidden" name="editedVehicleID" value="<?php echo($_POST['chosenVehicleID']); ?>">
        ...
        <form method="post" action="remove_vehicle.php">
            <input type="hidden" name="removedVehicleID" value="<?php echo($_POST['chosenVehicleID']); ?>">
